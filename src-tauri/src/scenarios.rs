...
pub fn load_figure_eight(state: &mut SimulationState) {
    ...
    let b1 = CelestialBody::new(
        id1,
        "Body A",
        Vec2::new(-0.97000436 * scale, 0.24308753 * scale),
        Vec2::new(0.4662036850 * v_factor, 0.4323657300 * v_factor),
        mass,
        8.0,
        "#FF4444",
        false,
    ...
    let b3 = CelestialBody::new(
        ...
        "Body C",
        Vec2::new(0.0, 0.0),
        Vec2::new(-0.93240737 * v_factor, -0.86473146 * v_factor),
        mass,
        8.0,
        "#4444FF",
        false,
